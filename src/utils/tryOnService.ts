  ...
  if (isTop && isMale) {
    ...
    switch (fitType) {
      ...
      case 'comfortable': {
        ...
        return `${base} FIT: COMFORTABLE — WIDER, NOT LONGER. ${comfortFit} The garment length remains exactly as shown in Image 2. The shirt is wider, not longer. SLEEVES: CRITICAL — the sleeve style and sleeve length come ONLY from Image 2. COMPLETELY DISCARD the original sleeves. If Image 2 shows short sleeves, the person wears short sleeves and bare arms are visible below. ${quality} Keep the person the same size in frame — crop the garment hem at the frame edge rather than shrinking the person. Prohibitions: fitted fabric, fabric touching torso sides, shrinking person, added chest/breast volume, added belly volume, altered body shape, original clothing visible, layering, tucked-in shirt, original sleeves visible, long sleeves when Image 2 shows short sleeves, color shift from Image 2, dress-like length, shorter hemline than Image 2, longer hemline than Image 2.`
      }
      default: { // regular
        ...
        return `${base} FIT: REGULAR. ${regularFit} The garment length remains exactly as shown in Image 2. SLEEVES: CRITICAL — the sleeve style and sleeve length come ONLY from Image 2. COMPLETELY DISCARD the original sleeves. If Image 2 shows short sleeves, the person wears short sleeves and bare arms are visible below. If Image 2 shows long sleeves, the person wears long sleeves. Do NOT keep the original sleeve length. ${quality} Prohibitions: skin-tight fabric, oversized look, added chest/breast volume, added belly volume, altered body shape, ANY trace of original clothing, layering, collar/sleeve/hem visible underneath, tucked-in shirt, original sleeves visible, long sleeves when Image 2 shows short sleeves, color shift from Image 2, shorter hemline than Image 2, longer hemline than Image 2.`
      }
    }
  } else if (isTop) {
