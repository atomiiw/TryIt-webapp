...
function generateTryOnPrompt(clothingInfo: ClothingInfo, fitType: FitType): string {
  ...
  if (isTop) {
    ...
    switch (fitType) {
      case 'tight':
        return `Virtual try-on. The person in Image 1 is wearing the ${itemType} from Image 2. ${style} Subject: The exact same person from Image 1 — identical face, body shape, body size, chest size, belly size, skin tone, hair, pose. The person's chest, belly, and overall body shape are exactly as in Image 1 with zero modification. Untuck any clothing first. Then completely remove all original upper body clothing and replace with the ${itemType} from Image 2. Composition: Straight-on mid-body framing. The virtual camera is pulled back far enough to show the person's full head, full torso, and the complete hem of the garment in frame. All body parts scale equally and uniformly. Fit: Only the width changes — the fabric is stretched taut against the skin with 0mm air gap. The shape of the shoulders and hip bones is visible pressing through the material. Zero wrinkles, zero folds, zero bunching. Chest area lays flat and smooth. The garment is tight in width only. The garment length remains exactly as shown in Image 2. Prohibitions: Added chest or breast volume, added belly volume, altered body shape, loose fabric, any original upper body clothing visible, jacket, hoodie, sweater, layering, disproportionate body parts, cropped or shortened shirt, shorter hemline than Image 2, tucked-in shirt, any part of shirt tucked into pants, sleeve length different from Image 2. ${mandatory} The tightness affects width only.`
      case 'comfortable':
        return `Virtual try-on. The person in Image 1 is wearing the ${itemType} from Image 2. ${style} Subject: The exact same person from Image 1 — identical face, body shape, body size, skin tone, hair, pose. The person's chest, belly, and overall body shape are exactly as in Image 1 with zero modification. Untuck any clothing first. Then completely remove all original upper body clothing and replace with the ${itemType} from Image 2. Composition: The virtual camera is pulled back far enough to show the person's full head, full torso, and the complete hem of the garment in frame. All body parts — head, shoulders, torso, hips — scale down equally and uniformly together as if photographed from a greater distance. If the hem would fall below the frame of the original photo, crop the hem rather than shrinking the person. Fit: Only the width is larger — the shirt is one full size wider than the person's body. 50mm of visible air gap between fabric and torso on each side. Shoulder seams drop 30mm past the natural shoulder bone. Sleeves visibly wider than the arms. 5-7 prominent vertical folds down the front. Body shape hidden by excess width. The shirt is wider, not longer. Prohibitions: Added chest or breast volume, added belly volume, altered body shape, fitted fabric, fabric touching torso sides, any original upper body clothing visible, jacket, hoodie, sweater, layering, shrinking torso independently of head, disproportionate body parts, dress-like length, shorter hemline than Image 2, longer hemline than Image 2, tucked-in shirt, any part of shirt tucked into pants, sleeve length different from Image 2. ${mandatory} The shirt is wider, not longer.`
      default:
        return `Virtual try-on. The person in Image 1 is wearing the ${itemType} from Image 2. ${style} Subject: The exact same person from Image 1 — identical face, body shape, body size, skin tone, hair, pose. The person's chest, belly, and overall body shape are exactly as in Image 1 with zero modification. Untuck any clothing first. Then completely remove all original upper body clothing and replace with the ${itemType} from Image 2. Composition: Straight-on mid-body framing. The virtual camera is pulled back far enough to show the person's full head, full torso, and the complete hem of the garment in frame. All body parts scale equally and uniformly. Fit: Standard retail fit. The fabric skims the body with approximately 10mm of space between skin and fabric. Shoulder seams sit exactly on the shoulder bone. A few natural creases at the waist. Body shape suggested but not defined through the fabric. Prohibitions: Added chest or breast volume, added belly volume, altered body shape, skin-tight fabric, oversized look, any original upper body clothing visible, jacket, hoodie, sweater, layering, disproportionate body parts, shorter hemline than Image 2, longer hemline than Image 2, tucked-in shirt, any part of shirt tucked into pants, sleeve length different from Image 2. ${mandatory}`
    }
  } else {
